...
if (!empty($_POST)) {
    ...
    //**********************************************************************************/
    $result = $pdo->prepare('DELETE FROM ambiance WHERE id= ?'); 
    ...
    <div class="starter-template">  
        <form method="POST" action="" enctype='multipart/form-data'>
            ...
            <div class="form-group">
                ...
                <br>
                <input style="width:20%;" type="text" class="form-control" placeholder="id" id="Supprime" name="Supprime" >
            </div>

            <button type="submit" class="btn btn-light" id="OK">Enregistrer</button>
